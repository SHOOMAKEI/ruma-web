...
class HasRoleOrPermissionDirective extends BaseDirective implements FieldMiddleware
{
        ...
        return $next(
            $fieldValue->setResolver(
                function ($root, array $args, GraphQLContext $context, ResolveInfo $resolveInfo) use ($resolver) {
                    ...
                    $this->authorize($user, $role, $permission);
    ...
    protected function authorize(User $user,$role, $permission): void
    {
    ...
    public static function definition(): string
    {
        ...
        """
        Check if user has role or permission to access the field.
        """
        directive @hasRoleOrPermission(
            """
            user role
            """
            role: String
