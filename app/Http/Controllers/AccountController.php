...
class AccountController extends Controller
{
    ...
    public function store(Request $request, UserAccountRepository $repository)
    {
        if(!is_null($repository->createAccount($request->toArray())))
        {
            return $repository->createAccount($request->toArray());
        }
