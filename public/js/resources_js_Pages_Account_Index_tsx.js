...
function Index() {
  ...
  return react_1["default"].createElement(CardWrapper_1["default"], null, react_1["default"].createElement("table", {
  ...
  }, react_1["default"].createElement("th", null, "Username"), react_1["default"].createElement("th", null, "Email"), react_1["default"].createElement("th", null, "Is Active"), react_1["default"].createElement("th", null, "Actions"))), react_1["default"].createElement("tbody", null, users && users.map(function (user) {
    return react_1["default"].createElement("tr", {
      key: user.id
    }, react_1["default"].createElement("td", null, user.username), react_1["default"].createElement("td", null, user.email), react_1["default"].createElement("td", null, user.is_active ? react_1["default"].createElement("span", {
    ...
    auth.user.id === user.id ? '' : react_1["default"].createElement(react_bootstrap_1.Dropdown.Item, {
      as: ToggleDropdown_1.CustomDropdownMenuItem
    }, react_1["default"].createElement(inertia_react_1.InertiaLink, {
