...
export default  () => {
    ...
    fill="#000000" opacity="0.3"/>
                                ...
                                <li className="nav-item mr-3">
                                    <a className="nav-link" data-toggle="tab" href="#kt_user_edit_tab_2">
														<span className="nav-icon">
															<span className="svg-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
    ...
    fill="#000000" fill-rule="nonzero"/>
                                ...
                                <li className="nav-item mr-3">
                                    <a className="nav-link" data-toggle="tab" href="#kt_user_edit_tab_3">
                                        ...
                                        <span className="nav-text font-size-lg">Change Password</span>
                                    </a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" data-toggle="tab" href="#kt_user_edit_tab_4">
														<span className="nav-icon">
															<span className="svg-icon">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                     xmlns:xlink="http://www.w3.org/1999/xlink"
                    ...
                    <div className="card-body">
                        <form className="form" id="kt_form">
                            <div className="tab-content">
                                ...
                                <div className="tab-pane px-7" id="kt_user_edit_tab_2" role="tabpanel">
                                    <div className="row">
    ...
    className="col-form-label col-3 text-lg-right text-left"/>
                                                ...
                                                <div className="form-group row">
                                                    <label
                                                        className="col-form-label col-3 text-lg-right text-left">Username</label>
                                                    <div className="col-9">
                                                        <div
                                                ...
                                                <div className="form-group row">
                                                    ...
                                                    <div className="col-9">
                                                        ...
                                                        <span className="form-text text-muted">Email will not be publicly displayed.
																		<a href="#">Learn more</a>.</span>
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label
                                                        className="col-form-label col-3 text-lg-right text-left">Language</label>
                                                    <div className="col-9">
                                                        <select
                                                            className="form-control form-control-lg form-control-solid">
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-form-label col-3 text-lg-right text-left">Time
                                                        Zone</label>
                                                    <div className="col-9">
                                                        <select
                                                            className="form-control form-control-lg form-control-solid">
                                                ...
                                                <div className="form-group row align-items-center">
                                                    <label
                                                        className="col-form-label col-3 text-lg-right text-left">Communication</label>
                                                    <div className="col-9">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-7">
                                            <div className="row">
                                                ...
                                                <div className="col-9">
                                                    <h6 className="text-dark font-weight-bold mb-10">Security:</h6>
                                                </div>
                                            </div>
                                            <div className="form-group row">
                                                <label className="col-form-label col-3 text-lg-right text-left">Login
                                                    verification</label>
                                                <div className="col-9">
                                                    <button type="button"
                                                            className="btn btn-light-primary font-weight-bold btn-sm">Setup
                                                        login verification
                                                    </button>
                                                    <div className="form-text text-muted mt-3">After you log in, you
                                            ...
                                            <div className="form-group row">
                                                <label className="col-form-label col-3 text-lg-right text-left">Password
                                                ...
                                                <div className="col-9">
                                                    ...
                                                    <div className="form-text text-muted">For extra security, this
                                                        requires you to confirm your email or phone number when you
                                                        reset your password.
                                                        <a href="#" className="font-weight-bold">Learn more</a>.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="form-group row mt-10">
                                                ...
                                                <div className="col-9">
                                                    <button type="button"
                                                            className="btn btn-light-danger font-weight-bold btn-sm">Deactivate
                                                        your account ?
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-xl-7">
                                                <div className="row mb-5">
                                                    ...
                                                    <div className="col-9">
                                                        <div
                                                            ...
                                                            <div className="alert-text font-weight-bold">Configure user
                                                                passwords to expire periodically.
                                                                <br>Users will need warning that their passwords are
                                                                    going to expire, or they might inadvertently get
                                                                    locked out of the system!</div>
                                                ...
                                                <div className="row">
                                                    <label className="col-3"></label>
                                                    <div className="col-9">
                                                        <h6 className="text-dark font-weight-bold mb-10">Change Or
                                                            Recover Your Password:</h6>
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label className="col-form-label col-3 text-lg-right text-left">Current
                                                        Password</label>
                                                    <div className="col-9">
                                                        <input
                                                            className="form-control form-control-lg form-control-solid mb-1"
                                                            type="text" value="Current password">
                                                            <a href="#" className="font-weight-bold font-size-sm">Forgot
                                                                password ?</a>
                                                    </div>
                                                </div>
                                                <div className="form-group row">
                                                    <label className="col-form-label col-3 text-lg-right text-left">New
                                                        Password</label>
                                                    <div className="col-9">
                                                        <input
                                                            className="form-control form-control-lg form-control-solid"
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-form-label col-3 text-lg-right text-left">Verify
                                                        Password</label>
                                                    <div className="col-9">
                                                        <input
                                                            className="form-control form-control-lg form-control-solid"
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-xl-7">
                                                <div className="row">
                                                    ...
                                                    <div className="col-9">
                                                        <a href="#" className="btn btn-light-primary font-weight-bold">Save
                                                            changes</a>
                                                        <a href="#"
                                                           className="btn btn-clean font-weight-bold">Cancel</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="tab-pane px-7" id="kt_user_edit_tab_4" role="tabpanel">
                                    <div className="row">
                                        <div className="col-xl-2"></div>
                                        <div className="col-xl-8">
                                            <div className="my-2">
                                                <div className="row">
                                                    <label
                                                        className="col-form-label col-3 text-lg-right text-left"></label>
                                                    <div className="col-9">
                                                        <h6 className="text-dark font-weight-bold mb-7">Setup Email
                                                            Notification:</h6>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="form-group row">
                                                    <label className="col-form-label col-3 text-lg-right text-left">Send
                                            ...
                                            <div className="row">
                                                <label className="col-form-label col-3 text-lg-right text-left"></label>
                                                <div className="col-9">
                                                    <h6 className="text-dark font-weight-bold mb-7">Activity Related
                                                        Emails:</h6>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-8">
                                            <div className="form-group row">
                                                <label className="col-form-label col-3 text-lg-right text-left">When To
                                                    Email</label>
                                                <div className="col-9">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-8">
                                            <div className="row">
                                                <label className="col-form-label col-3 text-lg-right text-left"></label>
                                                <div className="col-9">
                                                    <h6 className="text-dark font-weight-bold mb-7">Updates From
                                                        Keenthemes:</h6>
                                                </div>
                                            </div>
                                            <div className="form-group row">
                                                ...
                                                <div className="col-9">
                                                    ...
                                                    <div className="checkbox-inline mb-2">
                                                        <label className="checkbox checkbox-success">
                                                            <input type="checkbox" checked="checked">
                                                                <span></span>Things you missed since you last logged
                                                                into Keen</label>
                                                    </div>
                                                    <div className="checkbox-inline mb-2">
                                                        <label className="checkbox checkbox-success">
